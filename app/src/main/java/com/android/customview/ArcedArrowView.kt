...
constructor(
   ...
   private var containerColors = listOf(
      ...
      Color.parseColor("#722f37"),
      Color.parseColor("#593E31"),
   ...
   private var backArrowPaint =
      Paint(Paint.ANTI_ALIAS_FLAG).apply { color = Color.parseColor(colorTransparentBlack) }
...
//        draw back arrow image
   ...
   private fun drawArrowImage(canvas: Canvas?) {
      ...
      arrowDrawable = resources.getDrawable(R.drawable.ic_launcher_foreground, null)
   ...
   private fun drawBackArrowImage(canvas: Canvas?) {
      canvas?.let {
         ...
         backArrowDrawable = resources.getDrawable(R.drawable.ic_launcher_foreground, null)
